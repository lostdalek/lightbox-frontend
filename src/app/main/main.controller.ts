module App {
  ...
  export class MainCtrl {
    ...
    constructor ($scope: IMainScope, appConfigService: App.Component.ConfigService) {

        var appConfig = appConfigService.getConfig();
        console.log('controller do want', appConfigService.getConfig('a.b'));
        console.log('controller do want', appConfigService.getConfig('a.bb.c'));
        console.log('controller do want', appConfigService.getConfig('assetsPath'));
        $scope.assetsPath= appConfig.assetsPath;
      var awesomeThings = [
      {
        'title': 'AngularJS1',
