...
export interface ITableSchemaService extends ng.IServiceProvider {


}

export interface ITableSchemaServiceProvider { // extends ITableSchemaService
...
export class TableSchemaService implements ITableSchemaService {
     ...
     */
    public $get(): ITableSchemaServiceProvider {
        return {
